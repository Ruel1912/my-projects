...
<article class="cabinet">
  ...
  <section class="cabinet_card cabinet_card_stop">
    <div class="cabinet_card_stop_content">
      ...
      <p class="cabinet_card-subtitle">Если у вас возникли трудности с оплатой, свяжитесь с нами и мы вам поможем
      </p>
      <a href="<?= Url::to(['help']) ?>" class="link link--blue cabinet_card_fill-form-link">
    ...
    <div class="cabinet_payment_content">
      ...
      <div class="cabinet_payment_group">
        <div class="cabinet_payment_group_left">
          <div class="cabinet_payment_group_left-group">
            <div class="cabinet_payment_group_left-group-content">
              ...
              <a class="btn btn--red" href="<?= $next['link_payment'] ?>" target="_blank">Оплатить
                сейчас</a>
              <?php endif; ?>
            </div>
          </div>
          ...
          <div class="cabinet_payment_group_left_row">
            <!--                                <ul class="cabinet_payment_group_left_row-item">
                                    ...
                                    <li class="cabinet_payment_group_left_row-item-undertitle"><?/*= $tariff->months + 1 */?></li>
                                </ul>-->
            <ul class="cabinet_payment_group_left_row-item">
            ...
            <ul class="cabinet_payment_group_left_row-item">
              <li class="cabinet_payment_group_left_row-item-title">Осталось к оплате</li>
              <li class="cabinet_payment_group_left_row-item-undertitle">
                <!-- Реализовать логику нахождения остатка от отплаты -->
        ...
        <div class="cabinet_payment_group_right">
          <p class="cabinet_payment_group_right-status">
            Статус:
          </p>
          <p class="cabinet_payment_group_right-status-name">
            <?php if($next['status'] == 0): ?>
  ...
  <section class="cabinet_card cabinet_card_сhoose-rate">
    <div class="cabinet_card_content">
      ...
      <a class="btn btn--red cabinet_card_сhoose-rate-link" href="<?= Url::to(['/site/payment']) ?>">Выбрать
        тариф</a>
    </div>
  </section>
  <section class="cabinet_card cabinet_card_сhoose-rate">
