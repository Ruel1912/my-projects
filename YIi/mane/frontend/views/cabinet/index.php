...
$this->registerCss($css);
  ...
  <!-- <div class="promotion__news">
        ...
        <p><span class="promotion__news-bold">АКЦИЯ:</span> Заполните Анкету и оплатите выбранный формат в <span
            ...
            <span class="promotion__news-bold">5 000 руб</span>. Вы уже остановите рост долгов и освободитесь от оплаты
            по всем кредитам!
        </p>
    </div> -->
  ...
  <section class="cabinet_card cabinet_card_docs">
    <div class="cabinet_card_content">
      ...
      <p class="cabinet_card-subtitle">
        Для продолжения процедуры отправьте недостающие документы прямо сейчас. Ознакомиться с полным списком
        можно во вкладке <a class="link link--blue cabinet_card_docs-link" href="<?= Url::to(['/cabinet/docs']) ?>">Мои
          документы</a>
      </p>
    </div>
  </section>
      ...
      <div class="cabinet_card_writing-off-debts_row">
        <div class="cabinet_card_writing-off-debts_row-item">
          ...
          <p class="cabinet_card_writing-off-debts_row-item-text">
            Вы заполняете Анкету и выбираете удобный способ оплаты
          </p>
        </div>
        <div class="cabinet_card_writing-off-debts_row-item">
