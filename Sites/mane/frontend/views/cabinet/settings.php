...
<article class="cabinet">
    ...
    <section class="cabinet_settings-tabs set1 cabinet_settings-personal">
        <div class="cabinet_settings-personal_content">
            ...
            <div class="cabinet_settings-personal_row">
                ...
                <input class="InputT cabinet_settings-personal_row-phone" type="tel" value="<?= $user->username ?>"
                    name="phone">
            </div>
            <div class="cabinet_settings-personal_row">
                <p class="cabinet_settings-personal_row-name">
    ...
    <section class="cabinet_settings-tabs set2 cabinet_settings-password">
        <div class="cabinet_settings-personal_content">
            ...
            <button style="margin-bottom: 20px;" type="button" class="btn btn--red saveEmail">Сохранить
                изменения</button>
            <div class="cabinet_settings-personal_row">
                <p class="cabinet_settings-personal_row-name">
                    Старый пароль
            ...
            <button type="button" class="btn btn--red savePass">Сохранить изменения</button>
        </div>
    </section>
    <?= Html::endForm(); ?>
    ...
    <section class="cabinet_settings-tabs set3 cabinet_settings-notification">
        <div class="cabinet_settings-personal_content">
            ...
            <label class="cabinet_settings-personal_label cabinet_settings-personal_label_last">
            ...
            <button type="submit" class="btn btn--red btn--submit-settings-last">Сохранить
                изменения</button>
        </div>
    </section>
    <?= Html::endForm(); ?>
