...
define('C_REST_CLIENT_ID','local.6130917843e0f4.82107582');//Application ID
define('C_REST_CLIENT_SECRET','RfUMBoUEmNLQF1QiBSSq0pT7wBj2C8NFRF9zQRDapG64PFV3fR');//Application key
// or
...
class CRest
{
	...
	public static function GetNewAuth($arParams)
	{
		$result = [];
		$arSettings = static::getAppSettings();
		if($arSettings !== false)
