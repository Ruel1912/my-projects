...
<body>
  ...
  <div class="wrapper">
      ...
      <div class="cabinet_main_container">
        <nav class="cabinet_main_nav">
          ...
          <div class="cabinet_main_nav_first">
            ...
            <button type="button" class="btn btn-popC">
              Связаться с юристом
            </button>
            <?php if (!empty($user->tariff_id) && !empty($user->deal_id) && !empty($user->stage_id)): ?>
            ...
            <aside class="cabinet_menu_aside">
              <div class="cabinet_menu_aside_content">
                ...
                <a class="link lunk--blue" target="_blank" href="<?= $datePaymentsBlock->link_payment ?>">Оплатить
                  сейчас</a>
              </div>
            </aside>
            <?php endif; ?>
          ...
          <div class="cabinet_main_nav_last">
            <ul class="cabinet_main_nav_column">
              <li class="cabinet_main_nav_column-item">
                <a class="cabinet_main_nav_column-item-link" href="<?= Url::to(['/cabinet/help']) ?>">Тех.поддержка</a>
              </li>
              <li class="cabinet_main_nav_column-item">
    ...
    <footer class="cabinet_footer">
      <div class="container">
        <a class="link link--white" href="tel:+7 901 234 56 78">+7 901 234 56 78</a>
      </div>
    </footer>
      ...
      <section class="popC">
        ...
        <div class="popC_Stap2">
          <div class="popC_Stap-content">
            ...
            <p class="popC_Stap-phone">+7 (495) 230-51-10</p>
          </div>
        </div>
      </section>
    </div>
