...
<article class="cabinet">
    <h2 class="cabinet-title title doc-title">Мои документы</h2>
...
JS
    ...
    <section class="cabinet-docs-filter">
        <label class="cabinet-docs-filter-btn <?= empty($_GET['filter']) ? 'clicked-type' : '' ?>">
            <input type="radio" onclick="return location.href = 'docs'" name="docs" value="all">
            Все документы
        </label>
        <label
            class="cabinet-docs-filter-btn <?= !empty($_GET['filter']) && $_GET['filter'] === 'done' ? 'clicked-type' : '' ?>">
            <input onclick="return location.href = 'docs?filter=done'" type="radio" name="docs" value="all">
            Загруженные
        </label>
        <label
            class="cabinet-docs-filter-btn <?= !empty($_GET['filter']) && $_GET['filter'] === 'wait' ? 'clicked-type' : '' ?>">
            <input onclick="return location.href = 'docs?filter=wait'" type="radio" name="docs" value="all">
            Нужно загрузить
        </label>
        <!-- <label
            class="cabinet-docs-filter-btn <?= !empty($_GET['filter']) && $_GET['filter'] === 'other' ? 'clicked-type' : '' ?>">
    ...
    <main class="cabinet-docs">
        ...
        <section class="cabinet-docs-item">
            ...
            <div class="cabinet-docs-item_row">
                ...
                <?= Html::beginForm("sent-file", 'POST', ['class' => 'form-file', 'enctype' => 'multipart/form-data']); ?>
                <input accept="<?= $valid ?>" type="file" name="files">
                <input type="hidden" name="type" value="Копии свидетельства о рождении несовершеннолетних детей">
                <?= Html::endForm(); ?>
                <?php endif; ?>
            </div>
            <div class="cabinet-docs-item_row">
        ...
        <section class="cabinet-docs-item">
            ...
            <div class="cabinet-docs-item_row">
                <h3 class="cabinet-docs-item_row-name">
                    ...
                    участок)
                    <?= valids::$additionalDescription['Копия свидетельства о праве собственности (квартира, гараж, 1 земельный участок)'] ?>
                </h3>
        ...
        <section class="cabinet-docs-item">
            ...
            <div class="cabinet-docs-item_row">
                <h3 class="cabinet-docs-item_row-name">
                    ...
                    недвижимости
                    <?= valids::$additionalDescription['Выписка из ЕГРН о правах отдельного лица на имеющиеся у него объекты недвижимости'] ?>
                </h3>
        ...
        <section class="cabinet-docs-item">
            ...
            <div class="cabinet-docs-item_row">
                <h3 class="cabinet-docs-item_row-name">
                    ...
                    супругу
                    <?= valids::$additionalDescription['Справка о наличии транспортных средств и сделок с ними за последние три года на Вас и супругу(супруга)'] ?>
                </h3>
        ...
        <section class="cabinet-docs-item">
            ...
            <div class="cabinet-docs-item_row cabinet-docs-item_column">
                ...
                <?= Html::beginForm("sent-file", 'POST', ['class' => 'form-file', 'enctype' => 'multipart/form-data']); ?>
                <input accept="<?= $valid ?>" type="file" name="files">
                <input type="hidden" name="type" value="Справка 2-НДФЛ за последние три года на Вас и супругу(супруга)">
                <?= Html::endForm(); ?>
                <?php endif; ?>
            </div>
        </section>
        ...
        <section class="cabinet-docs-item">
            ...
            <?php if (in_array('Объяснение должника', $arr)): ?>
            <div class="cabinet-docs-item_row cabinet-docs-item_column">
                <a class="link link--gray cabinet-docs-item_column-link" href="<?= Url::to(['img/example.png']) ?>"
                    download="Пример объяснения">Смотреть пример
                    документа</a>
                <p class="cabinet-docs-item_row-status cabinet-docs-item_row-upploaded">
                    Загружено
                </p>
