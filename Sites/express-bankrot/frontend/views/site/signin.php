    ...
    if (SignStapCounter === 0){
        ...
        if (flag){
            $('.Stap1').fadeOut(300, function() {
                $('.signin_main-subtitle-phone').text(phone);
              $('.Stap2').fadeIn(300);
                ...
                <div class="signin_main_wrapper">
                    ...
                    <div class="Staps Stap5">
                        <div class="Staps_content">
                            ...
                            <h2 class="signin_main-subtitle">
                            Для начала процедуры списания долгов вам необходимо выбрать удобный для вас <a class="sign-in-link-finish" href="<?= Url::to(["/cabinet/payment"])?>">Способ оплаты</a> 
                            </h2>
                            <h2 class="signin_main-subtitle">
                                Если у вас возник вопрос, свяжитесь с нами по номеру <a
                                    class="sign-in-link-finish js-footer_phone" href="tel:+7 (473) 280-01-01">+7 (473) 280-01-01</a>
                            </h2>
                        </div>
                    </div>
                </div>
