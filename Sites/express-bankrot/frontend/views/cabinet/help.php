...
?>
    ...
    <article class="cabinet">
        ...
        <h2 class="cabinet-subtitle">Если у вас возникли трудности в использовании сайта, напиши нам и решим вашу проблему</h2>
        ...
        <?php if (!empty($tiket)): ?>
            ...
            <div class="cabCont">
                ...
                <?php if ($v['isSupport'] === 1): ?>
                        <div class="cabinet_help_top_main_message">
                            <div style="background-image: url(<?= Url::to(['img/aboutpage-1.png']) ?>)" class="cabinet_help_top_main_message-icon"></div>
            ...
            <div class="cabinet_help_top_bottom">
                ...
                <button class="btn btn--blue btn--Message-submit">Отправить</button>
        ...
        <?php else: ?>
            ...
            <input class="btn btn--blue start__Helpdesk" name="startDesk" type="button" value="Начать диалог с тех.поддержкой">
        <?php endif; ?>
        </section>
    </article>
